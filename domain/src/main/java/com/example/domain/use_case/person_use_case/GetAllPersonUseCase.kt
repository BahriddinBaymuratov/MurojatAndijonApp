...
typealias GetAllPersonBaseUseCase = BaseUseCase<String, Flow<ResponseL<List<Person>>>>

class GetAllPersonUseCase @Inject constructor(
    private val repository: PersonRepository
): GetAllPersonBaseUseCase{
    override suspend fun invoke(params: String): Flow<ResponseL<List<Person>>> {
        return repository.getAllPerson(params)
    }
}